...
class Position(Worker):
    def __init__(self, *args, **kwargs):
        # Получает все аргументы из базового класса
...
employee = Position('Иван', 'Иванов', 'Программист', 1000, 500)
print(f'Полное имя сотрудника - {employee.get_full_name()}')
print(f'Доход сотрудника на позиции "{employee.position}" составляет {employee.get_total_income()}$')
